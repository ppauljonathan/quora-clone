RSpec.shared_examples 'Admin Users Authenticable' do |method, path_helper|
  context 'when user not logged in' do
    it 'should redirect' do
      path = path_helper == :admin_users_path ? public_send(:admin_users_path) : public_send(path_helper, user)
